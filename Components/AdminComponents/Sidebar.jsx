    ...
    <div className='flex flex-col bg-slate-100'>
      ...
      <div className='w-28 sm:w-80 h-[100vh] relative py-12 border border-black'>
        ...
        <Link href='/admin/addProduct' className='flex items-center border border-black gap-3 font-medium px-3 py-2 bg-white shadow-[-2px_5px_0px_#000000]'>
         ...
         <Link href='/admin/addRestaurants' className='flex items-center border mt-5 border-black gap-3 font-medium px-3 py-2 bg-white shadow-[-2px_5px_0px_#000000]'>
             <Image src={assets.add_icon} alt='' width={28}/>
             <p>Add restaurants</p>
         </Link>
         <Link href='/admin/addHotel' className='flex items-center border mt-5 border-black gap-3 font-medium px-3 py-2 bg-white shadow-[-2px_5px_0px_#000000]'>
             <Image src={assets.add_icon} alt='' width={28}/>
             <p>Add Hotels</p>
         </Link>
